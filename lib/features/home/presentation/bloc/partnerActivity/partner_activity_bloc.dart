...
class PartnerActivityBloc extends Bloc<PartnerActivityEvent, PartnerActivityState> {
  ...
  Future<void> _onFetchRequested(dynamic event, Emitter<PartnerActivityState> emit) async {
  ...
  Future<void> _onSendHighFiRequested(dynamic event, Emitter<PartnerActivityState> emit) async {
