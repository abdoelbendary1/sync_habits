...
@override
String toString() {
  return 'UserEntity(id: $id, name: $name, email: $email, avatarUrl: $avatarUrl, totalPoints: $totalPoints, currentLevel: $currentLevel, highestStreak: $highestStreak, isOnline: $isOnline, progress: $progress, lastSeen: $lastSeen, partnerId: $partnerId)';
}
...
class _UserEntity implements UserEntity {
  const _UserEntity({required this.id, required this.name, required this.email, required this.avatarUrl, this.totalPoints = 0, this.currentLevel = 1, this.highestStreak = 0, this.isOnline = false, this.progress = 0, this.lastSeen, this.partnerId});
